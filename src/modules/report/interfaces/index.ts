...
export { IBatchDeleteReportApplication } from './applications/batch-delete.report.application.interface';
...
export { IListReportService } from './services/list.reports.service.interface';
export { IDeleteByIdReportService } from './services/delete-by-id.report.service.interface';
export { IBatchDeleteReportService } from './services/batch-delete.report.service.interface';
