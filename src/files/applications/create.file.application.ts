...
import { ICreateFileApplicationInterface } from '../interfaces/applications/create.file.application.interface';
import { IStoreFileService } from '../interfaces/services/store.file.service.interface';
import { TYPES } from '../interfaces/types';

@Injectable()
export class CreateFileApplication implements ICreateFileApplicationInterface {
  constructor(
